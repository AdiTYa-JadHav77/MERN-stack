...
class Wallpaper extends React.Component{
    ...
    onClickHandler=(event)=>{
        ...
        axios({
            url:`https://guarded-cliffs-31948.herokuapp.com/restaurants/${locID}`,
            method:'GET',
            ...
            <ul  className="list-lab" style={{backgroundColor: 'white',marginTop: '4px',listStyleType:'none'}}>
                {
                    ...
                    <li style={{ color: '#192f60'}} key={index}onClick={()=>this.selectedText(item)}>
                         {/* <img style={{borderRadius:'50px',padding:'3px',marginRight:'11px'}} src="../../Assets/img1.png" alt="Sorry" height="40px" width="40px" /> */}
