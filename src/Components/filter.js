...
class Filter extends React.Component{
    ...
    handelRatingChange=(rating)=>{
        ...
        .then(response =>{
            this.setState({restaurants: response.data.restaurants,rating,pageCount:response.data.pageCount})
        })
        .catch( err => console.log(err))
    ...
    <main>
        <div className="container">
            <div className="title-text my-4 ">Places in Delhi</div>
            <div className="row ">
                ...
                <div className="col-lg-3 col-sm-4 collapse show" id="filter" >
                    <div className="filter-block ">
                        ...
                        <div className="f3">
                            <input type="radio" name="price" className="m-2" onChange={()=>this.handelRatingChange(5)}/>5.0<br/>
                            <input type="radio" name="price" className="m-2" onChange={()=>this.handelRatingChange(4.5)}/>4.5<br/>
                            <input type="radio" name="price" className="m-2" onChange={()=>this.handelRatingChange(4)}/>4.0<br/>
                            <input type="radio" name="price" className="m-2" onChange={()=>this.handelRatingChange(3.5)}/>3.5<br/>
                ...
                {restaurants.length > 0 ? restaurants.map((item,index) =>{
                    return <div className="item mb-4 "key={index} onClick={()=> this.handeNavigate(item._id)}>
                        ...
                        <div className="rest1-span text-start">
                            ...
                            <span className="rating"><i class="fa fa-star" aria-hidden="true"></i>{item.aggregate_rating}</span>
